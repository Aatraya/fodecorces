...
* after the functions made, memory for problems is made and the pre existing problems are stored. then code for the menu interactions is made. this code is rig